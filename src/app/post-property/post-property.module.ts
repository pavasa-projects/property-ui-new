...
import { PostPropertyUnitConfigurationComponent } from './post-property-unit-configuration/post-property-unit-configuration.component';
import {NgMultiSelectDropDownModule} from "ng-multiselect-dropdown";



@NgModule({
  declarations: [PostPropertyDetailsComponent,  PostPropertyLocationComponent, PostPropertyMoreDetailsComponent, PostPropertyPhotosComponent, PostPropertyPricingPlanComponent, ThankYouComponent, SelectableIconComponent, PostPropertyUnitConfigurationComponent],
  imports: [
    CommonModule,
